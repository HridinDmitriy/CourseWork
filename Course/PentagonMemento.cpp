...
void PentagonMemento::set_state(const Color& _f_color, const Color& _b_color, const Color& _out_color,
...
float PentagonMemento::get_radius() const
{
	return radius;
}

MyShape* PentagonMemento::create_shape() const
{
	Pentagon* tmp_shape = new Pentagon();
...
void PentagonMemento::save_to_file(std::ostream& strm) const
{
	strm << shape_id() << " ";
...
void PentagonMemento::restore_from_file(std::istream& strm)
{
...
const char* PentagonMemento::shape_id() const
{
	return "pent";
}
